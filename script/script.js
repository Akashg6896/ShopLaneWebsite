...
// ).then((res) => res.json())
//   .then((productList) =>
//     createCardSectionContainer('Clothing', 0, productList.length / 2)
//   )
//   .then((clothSectionContainer) =>
//     document.body.appendChild(clothSectionContainer)
//   )
//   .then()
// import productInfo from './product-details.js'
import {
...
$(document).ready(function () {
  ...
  async function clothingAndAccessories() {
    ...
    // productList =
    //   localProductList? localProductList : JSON.parse(productList)
    if (localProductList) {
    ...
    // if (localProductList == null || localProductList == undefined) {
    // productList = fetchProductList()
    window.localStorage.setItem('productList', JSON.stringify(productList))
    // } else productList = window.localStorage.getItem('productList')
    // console.log(window.localStorage.getItem('helo'))
    ...
    // console.log(clothSectionContainer, accSectionContainer)
    // document.body.appendChild(clothSectionContainer)
    // const accSectionContainer = createCardSectionContainer(
    //   'Accessories',
    //   productList.length / 2,
    //   productList.length
    // )
    // document.body.appendChild(accSectionContainer)
    // console.log(productList)
    for (let { id } of productList) {
      ...
      cardElem.addEventListener('click', async (event) => {
        ...
        // script.src = './script/product-details.js'
        // document.body.append(script)
        // // script.onload = () => {
        // productInfo(cardElem, id)
        // // }
